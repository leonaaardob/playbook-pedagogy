...
| `les-primitives/learning-content/course-01/outputs/plan-cours-1-agentic-engineering.md` | `learning-content/course-01/outputs/plan-cours-1-agentic-engineering.md` | Cadrage le plus complet : public, promesse, progression, formats, carte des six cours, workshop, évaluation et politique technique. | Référence de travail actuelle du cours 01 et de la carte inter-cours. Certaines sections sont explicitement « à soumettre à validation » : ne pas les présenter comme des décisions globales déjà ratifiées. | `3a904de4b44eb769ec453796183fa109a19694b5f3ab4ede142b5a3d27cd8413` |
...
- Le PRD et les documents de design de Les Primitives ne sont pas copiés ici : le PRD est explicitement « en revue » et décrit un catalogue de **sept** cours, en divergence avec la carte actuelle de **six** cours du plan de cours 01. Cette divergence doit rester visible jusqu’à arbitrage.
...
1. Statut exact du septième cours décrit par le PRD, ou confirmation que le catalogue cible est désormais limité à six cours.
2. Politique d’évaluation uniforme au-delà du cours 01, notamment lorsque le comportement dépend d’un modèle non déterministe.
3. Matrice de prérequis techniques complète (versions, systèmes et environnement local) pour chaque cours.
4. Politique de variantes fournisseur : le plan fixe OpenRouter comme voie d’inférence apprenant, tandis que le corpus de cours 01 conserve des variantes de SDK Anthropic, OpenAI et OpenRouter. Le playbook doit formaliser la règle sans la deviner.
